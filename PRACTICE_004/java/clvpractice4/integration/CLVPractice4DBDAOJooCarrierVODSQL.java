...
*@FileName : CLVPractice4DBDAOJooCarrierVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CLVPractice4DBDAOJooCarrierVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice4DBDAOJooCarrierVODSQL(){
		setQuery();
		...
		query.append("FileName : CLVPractice4DBDAOJooCarrierVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
