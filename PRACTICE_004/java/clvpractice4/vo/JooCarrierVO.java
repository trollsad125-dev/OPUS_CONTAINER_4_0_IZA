...
public class JooCarrierVO extends AbstractValueObject {
	...
	private Collection<JooCarrierVO> models = new ArrayList<JooCarrierVO>();
...
/**
	 ...
	 * @return JooCarrierVO[]
	 */
	public JooCarrierVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JooCarrierVO[]
	 */
	public JooCarrierVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JooCarrierVO model = null;
	...
	public JooCarrierVO[] getJooCarrierVOs(){
		JooCarrierVO[] vos = (JooCarrierVO[])models.toArray(new JooCarrierVO[models.size()]);
		return vos;
	}
