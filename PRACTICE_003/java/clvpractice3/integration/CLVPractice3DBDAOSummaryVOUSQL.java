...
*@FileName : CLVPractice3DBDAOSummaryVOUSQL.java
...
public class CLVPractice3DBDAOSummaryVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice3DBDAOSummaryVOUSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.clvpractice3.clvpractice3.integration").append("\n"); 
		query.append("FileName : CLVPractice3DBDAOSummaryVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
