...
*@FileName : CLVPractice3DBDAODetailVODSQL.java
...
public class CLVPractice3DBDAODetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice3DBDAODetailVODSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.clvpractice3.clvpractice3.integration").append("\n"); 
		query.append("FileName : CLVPractice3DBDAODetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
