...
*@FileName : CLVPractice3DBDAOSummaryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CLVPractice3DBDAOSummaryVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice3DBDAOSummaryVORSQL(){
		setQuery();
		...
		query.append("FileName : CLVPractice3DBDAOSummaryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
