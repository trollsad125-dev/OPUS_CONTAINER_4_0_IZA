...
*@FileName : CLVPractice3DBDAOSummaryVODSQL.java
...
public class CLVPractice3DBDAOSummaryVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice3DBDAOSummaryVODSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.clvpractice3.clvpractice3.integration").append("\n"); 
		query.append("FileName : CLVPractice3DBDAOSummaryVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
