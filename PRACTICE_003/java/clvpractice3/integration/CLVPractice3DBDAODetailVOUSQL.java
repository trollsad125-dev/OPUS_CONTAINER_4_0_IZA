...
*@FileName : CLVPractice3DBDAODetailVOUSQL.java
...
public class CLVPractice3DBDAODetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice3DBDAODetailVOUSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.clvpractice3.clvpractice3.integration").append("\n"); 
		query.append("FileName : CLVPractice3DBDAODetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
