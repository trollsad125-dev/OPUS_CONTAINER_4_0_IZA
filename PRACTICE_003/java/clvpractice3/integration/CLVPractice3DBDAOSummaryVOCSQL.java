...
*@FileName : CLVPractice3DBDAOSummaryVOCSQL.java
...
public class CLVPractice3DBDAOSummaryVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice3DBDAOSummaryVOCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.clvpractice3.clvpractice3.integration").append("\n"); 
		query.append("FileName : CLVPractice3DBDAOSummaryVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
