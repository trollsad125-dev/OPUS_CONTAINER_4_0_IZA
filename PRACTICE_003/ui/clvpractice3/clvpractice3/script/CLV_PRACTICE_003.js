	...
	switch (sheetObj.id) {
	 ...
	 case "t2sheet1": // t2sheet1 init     
        ...
        var cols = [ 
               ...
               {Type:"Combo",     Hidden:0, Width:45,   Align:"Center",  ColMerge:0,   SaveName: prefix + "rev_exp",         	KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0, ComboText : "Rev|Exp", ComboCode : "R|E" },
