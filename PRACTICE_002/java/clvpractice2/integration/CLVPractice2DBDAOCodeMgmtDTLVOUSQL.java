...
*@FileName : CLVPractice2DBDAOCodeMgmtDTLVOUSQL.java
...
public class CLVPractice2DBDAOCodeMgmtDTLVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLVPractice2DBDAOCodeMgmtDTLVOUSQL(){
		setQuery();
		...
		query.append("FileName : CLVPractice2DBDAOCodeMgmtDTLVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
