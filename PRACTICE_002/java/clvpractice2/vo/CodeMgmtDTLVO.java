...
public class CodeMgmtDTLVO extends AbstractValueObject {
	...
	public CodeMgmtDTLVO(String ibflag, String pagerows, String intgCdId, String intgCdValCtnt, String intgCdValDpDesc, String intgCdValDesc, String intgCdValDpSeq, String aplyStDt, String aplyEndDt, String codeid) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCodeid(JSPUtil.getParameter(request, prefix + "codeid", ""));
	...
	public CodeMgmtDTLVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] codeid = (JSPUtil.getParameter(request, prefix	+ "codeid", length));
