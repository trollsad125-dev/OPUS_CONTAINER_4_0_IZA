...
*@FileName : ComErrMsgVO.java
*@FileTitle : ComErrMsgVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.clv.clvtraining.errmsgmgmt.vo;
...
public class ComErrMsgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComErrMsgVO> models = new ArrayList<ComErrMsgVO>();
	...
	public ComErrMsgVO(String ibflag, String pagerows, String errMsgCd, String langTpCd, String errTpCd, String errLvlCd, String errMsg, String errDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return ComErrMsgVO[]
	 */
	public ComErrMsgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComErrMsgVO[]
	 */
	public ComErrMsgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
	...
	public ComErrMsgVO[] getComErrMsgVOs(){
		ComErrMsgVO[] vos = (ComErrMsgVO[])models.toArray(new ComErrMsgVO[models.size()]);
		return vos;
	}
